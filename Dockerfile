# Multi-stage Dockerfile for Railway deploy with Ruby 3.3
# Builds Chatwoot from source using the official docker/Dockerfile approach

# pre-build stage
FROM node:24-alpine as node
FROM ruby:3.3.7-alpine3.20 AS pre-builder
...
# Apply custom overlay (VendeEnOne extensions, cable.yml fix)
